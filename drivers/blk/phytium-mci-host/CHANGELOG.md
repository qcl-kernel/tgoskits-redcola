...
## [0.3.6](https://github.com/rcore-os/tgoskits/compare/phytium-mci-host-v0.3.5...phytium-mci-host-v0.3.6) - 2026-08-11

### Other

- updated the following local packages: dma-api, sdio-host2, sdmmc-protocol
