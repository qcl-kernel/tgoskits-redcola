...
## [0.4.5](https://github.com/rcore-os/tgoskits/compare/sdhci-host-v0.4.4...sdhci-host-v0.4.5) - 2026-08-11

### Other

- updated the following local packages: dma-api, rdif-block, sdio-host2, sdmmc-protocol
