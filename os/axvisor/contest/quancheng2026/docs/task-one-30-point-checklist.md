...
Latest verified upload package source head
`dca3bfdd58b3f1df14258c622cb824325ca89946` is a
documentation/package-manifest refresh on top of the recorded runtime
evidence. Follow-up PR head `212b449e18a01218c1c9f74a081267e28605da13`
records that package proof in the review documents. The checkpoint upload
package verifies with `FINAL_PACKAGE_VERIFY=PASS`, fresh-unzip verify `PASS`,
`63` files, and ZIP SHA256
...
| Current-head long pressure proof | Exact submitted head `746042293` has a 3-run, 2-worker, 30000-sample hub stability repeat. Prior head `b706a02c` has a 30000-sample hub matrix at 0/1/2/4 Linux workers. Earlier 30000-sample TAP/tcpdump rows from head `91cb7c0f` provide packet capture and 4-worker TAP overcommit evidence. Recorded head `a9ceb7dc` has an additional 30000-sample 2-worker hub proof with UDP `20/20`, QCZ1 `10/10`, AI `10/10` and no missing markers. |
